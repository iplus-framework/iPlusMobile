...
namespace gip.vbm.mobile.Helpers
{
    public struct HexColor
    {
        ...
        public byte A
        {
            get { return ConvertToRGBByte(_color.Alpha); }
        }

        public byte R
        {
            get { return ConvertToRGBByte(_color.Red); }
        }

        public byte G
        {
            get { return ConvertToRGBByte(_color.Green); }
        }

        public byte B
        {
            get { return ConvertToRGBByte(_color.Blue); }
        }
