...
namespace gip.vbm.mobile.Droid
{
    ...
    /// </summary>
    public class CheckBoxRenderer : ViewRenderer<gip.vbm.mobile.Controls.CheckBox, Android.Widget.CheckBox>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<gip.vbm.mobile.Controls.CheckBox> e)
        {
