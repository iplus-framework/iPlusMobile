...
namespace gip.vb.mobile.Controls
{
    ...
    public partial class BoxViewButton : ContentView
	{
        ...
        public static readonly BindableProperty BorderCheckedColorProperty = BindableProperty.Create("BorderCheckedColor", typeof(Color), typeof(BoxViewButton), Color.Transparent);
        ...
        public static readonly BindableProperty BorderUnCheckedColorProperty = BindableProperty.Create("BorderUnCheckedColor", typeof(Color), typeof(BoxViewButton), Color.Transparent);
        ...
        public static readonly BindableProperty FillCheckedColorProperty = BindableProperty.Create("FillCheckedColor", typeof(Color), typeof(BoxViewButton), Color.Transparent);
        ...
        public static readonly BindableProperty FillUnCheckedColorProperty = BindableProperty.Create("FillUnCheckedColor", typeof(Color), typeof(BoxViewButton), Color.Transparent);
        ...
        private void InitColors()
        {
            ...
            if (ButtonEffect == BoxViewButtonEffect.HighlightBorderWithTheme || ButtonEffect == BoxViewButtonEffect.HighlightFillWithTheme)
            {
                ...
                if (hColor.A > 100)
                    colorTransFill = Color.FromRgba(hColor.R, hColor.G, hColor.B, 40);
                BorderCheckedColor = colorTransBorder;
                FillCheckedColor = colorTransFill;
                BorderUnCheckedColor = Color.Transparent;
